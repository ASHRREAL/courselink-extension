(function () {
  ...
  const DARK_SHADOW_CSS = `
    ...
    [style*="background-color:#fff"],
    .d2l-dropdown-content-background,
    [class*="d2l-dropdown-content-background"],
    [class*="vui-dropdown"],
    [class*="vui-menu"],
    .vui-list,
    .d2l-navigation-s-dropdown,
    .vui-dropdown-menu-container,
    .d2l-menu {
      background-color: #1e2128 !important;
      background: #1e2128 !important;
      color: #e8eaf0 !important;
    ...
    .vui-dropdown-menu-pointer-outer {
      border-bottom-color: #2e3340 !important;
      background-color: transparent !important;
    }
    
    .vui-dropdown-menu-pointer-inner {
    ...
    if (settings.darkMode) {
      ...
      if (!darkStyleEl) {
        ...
        darkStyleEl.textContent = `
          ...
          html[data-cl-dark] .vui-dropdown-menu-container {
            background-color: #1e2128 !important; background: #1e2128 !important; border-color: #2e3340 !important; color: #e8eaf0 !important;
          }
